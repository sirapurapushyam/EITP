...
export default function PublicLandingPage() {
  return (
    <div className="min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top,_rgba(245,158,11,0.2),_transparent_35%),linear-gradient(180deg,#09111f_0%,#0f172a_100%)] text-white">
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col justify-between px-6 py-8 lg:px-10">
        ...
        <main className="grid gap-10 py-16 lg:grid-cols-[1.3fr_0.7fr] lg:items-center">
          <div className="min-w-0">
           ...
           <h1 className="font-display break-words text-3xl font-semibold leading-tight sm:text-4xl md:text-5xl lg:text-7xl">
  Entrepreneurship, Incubation, Training and Placement Cell
</h1>
